...
def disp(suspension_beam_width,proof_mass_length):
	...
	def main():
		...
		solve(a == l, u, bc)
		z_disp = u(beam_dist_final+suspension_beam_width+small_beam_length+proof_mass_length/2,
			beam_dist_final+suspension_beam_width+small_beam_length+proof_mass_length/2, \
			proof_mass_thickness/2)
