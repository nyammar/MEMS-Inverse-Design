# This project is done for class E240: Intro to MEMS lab
# taught by Prof. Roger Howe and Prof. Olav Solgaard.
#
# Project submitted by Nancy Ammar and Devin Ardeshna
#
# The genetic algorithm code and included files is largely inspired by the Master's thesis of Rui Amendoeira Esteves advised by Prof. Michael Kraft in KU Leuven.
#
#
## Genetic Algorithm 
